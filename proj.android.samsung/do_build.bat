...
call "%PHP_DIR%" ResourceCompiler.php "texture_packer=%TEXTURE_PACKER_DIR%;platform=android;project=%BUILD_PROJECT%;source=../Resources_storage;destination=../Resources;translate=en,ru,es,ja,pt,de,fr,ko,tr,it,uk,nl,pl,hu;translation_dir=../Resources_storage/translations"
