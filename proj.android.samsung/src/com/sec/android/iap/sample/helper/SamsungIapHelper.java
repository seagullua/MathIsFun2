...
public class SamsungIapHelper
{
    ...
    // IAP н�ём¶њм‹њ onActivityResult м—ђм„њ л°›кё° мњ„н•њ мљ”мІ­ мЅ”л“њ
    ...
    /**
     * SamsungIapHelper мѓќм„±мћђ Applicationмќ� ContextлҐј м‚¬мљ©н•њл‹¤.
     * constructor
     * @param _context
     */
    ...
    /**
     * IAP м„њл№„мЉ¤ мґ€кё°н™”к°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мЅњл°± н•Ём€�лҐј л“±лЎќн•њл‹¤.
    ...
    /**
     * {@link GetItemListTask}к°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мЅњл°±мќ„ л“±лЎќн•њл‹¤.
     * Register a callback to be invoked
    ...
    /**
     * {@link GetInboxListTask}к°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мЅњл°±мќ„ л“±лЎќн•њл‹¤.
     * Register a callback to be invoked
    ...
    public void installIapPackage( final Activity _activity )
    {
        Runnable OkBtnRunnable = new Runnable()
        {
            ...
            public void run()
            {
                ...
                // н—€л‹€мЅ¤ MR1 мќґмѓЃмќґл©ґ FLAG_INCLUDE_STOPPED_PACKAGESлҐј м¶”к°Ђн•њл‹¤.
    ...
    /**
     * IAP нЊЁн‚¤м§Ђк°Ђ м„¤м№�лђ�м–ґ мћ€лЉ” м§Ђ м—¬л¶Ђ н™•мќё
    ...
    /**
     * л””л°”мќґмЉ¤м—ђ м„¤м№�лђњ IAP нЊЁн‚¤м§Ђмќ� мњ нљЁм„± н™•мќё
    ...
    /**
     * IAP InterfaceлҐј м‚¬мљ©н•�кё° мњ„н•�м—¬ Service Bind мІ�л¦¬лҐј н•њл‹¤. 
     * мІ�л¦¬кІ°кіјлҐј Listenerм—ђ л°�н™�н•њл‹¤.
     * bind to IAPService
     *  
    ...
    /**
     * IAPмќ� init InterfaceлҐј н�ём¶њн•�м—¬ IAP мґ€кё°н™” мћ‘м—…мќ„ м§„н–‰н•њл‹¤.
    ...
    /**
     * IAP мѓЃн’€ лЄ©лЎќ Interface лҐј н�ём¶њн•�кі  кІ°кіјлҐј л°�н™�
    ...
    /**
     * IAP кµ¬л§¤н•њ мѓЃн’€ лЄ©лЎќ  Interface лҐј н�ём¶њн•�кі  кІ°кіјлҐј л°�н™�
    ...
    /**
     * IAPмќ� кІ°м њ Activity лҐј н�ём¶њн•њл‹¤.
    ...
    /**
     * м‹¤н–‰м¤‘мќё нѓњмЉ¤нЃ¬лҐј м¤‘м§Ђн•њл‹¤.
     * Stop running task
     */
    ...
    /**
     * IAP мў…лЈЊм‹њ м‚¬мљ©м¤‘мќё Connecter мў…лЈЊм™Ђ ServiceлҐј unbind м‹њн‚Ёл‹¤.
    ...
    /**
     * bindIapService л©”м†ЊмЉ¤к°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мќён„°нЋ�мќґмЉ¤ м •мќ�
    ...
    {
        /**
         * bindIapService л©”м†Њл“њк°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мЅњл°± л©”м†Њл“њ
    ...
    ///////////////////////////////////////////////////////////////////////////
    /**
     * IAP м„њл№„мЉ¤ мґ€кё°н™”к°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мЅњл°±н•Ём€�лҐј мњ„н•њ мќён„°нЋ�мќґмЉ¤ м •мќ�
     * Interface definition for a callback to be invoked
     * when {@link InitIapTask} has been finished.
     */
    ...
    private class InitIapTask  extends AsyncTask<String, Object, Boolean>
    {
        ...
        protected Boolean doInBackground( String... params )
        {
            try
            {
                // IAP мґ€кё°н™” Interface лҐј н�ём¶њн•�м—¬ кІ°кіјлҐј к°Ђм ём�Ёл‹¤.
        ...
        {
            // кІ°кіјмІ�л¦¬ : InitTask кІ°кіјк°Ђ м„±кіµмќё кІЅмљ°
            // InitTask returned true
            // ================================================================
            if( true == result )
            {
                // 1) мґ€кё°н™”к°Ђ м •мѓЃм ЃмњјлЎњ м™„лЈЊлђњ кІЅмљ°
                //    If initialization is completed successfully
                // ============================================================
                if( mErrorVO.getErrorCode() == IAP_ERROR_NONE )
                {
                    // мґ€кё°н™”м—ђ м„±кіµн–€мќ„ кІЅмљ° Listener мќ� onSucceedInitIap 
                    // мЅњл°± л©”м†Њл“њ н�ём¶њ
                ...
                // ============================================================
                // 2) IAP нЊЁн‚¤м§Ђмќ� м—…к·ёл €мќґл“њк°Ђ н•„мљ”н•њ кІЅмљ°
                ...
                // ============================================================
                // 3) IAP м—°лЏ™мќ„ мњ„н•њ мґ€кё°н™”м—ђ м‹¤нЊЁн•њ кІЅмљ°
    ...
    /**
     * {@link GetItemListTask}к°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мЅњл°±л©”м†ЊмЉ¤лҐј мњ„н•њ мќён„°нЋ�мќґмЉ¤
     * Interface definition for a callback to be invoked
     * when {@link GetItemListTask} has been finished.
     */
    ...
    private class GetItemListTask extends AsyncTask<String, Object, Boolean>
    {
        ...
        protected Boolean doInBackground( String... params )
        {
            try
            {
                // IAP мѓЃн’€ лЄ©лЎќ Interface лҐј н�ём¶њн•�м—¬ кІ°кіјлҐј к°Ђм ём�Ёл‹¤.
                ...
                // status Code, error String, extra String мќ„ м ЂмћҐн•ґл‘”л‹¤
        ...
        {
            // 1. кІ°кіјк°Ђ м„±кіµмќё кІЅмљ°
            //    result is true
            // ================================================================
            if( true == _result )
            {
                // 1) мѓЃн’€ л¦¬мЉ¤нЉёк°Ђ м„±кіµм ЃмњјлЎњ лЎњл”©лђ�м—€мќ„ кІЅмљ°
                ...
                // ============================================================
                // 3) мѓЃн’€ л¦¬мЉ¤нЉёлҐј к°Ђм ём�¤лЉ” лЏ™м•€ м—ђлџ¬к°Ђ л°њмѓќн•њ кІЅмљ°
    ...
    /**
     * {@link GetInboxListTask}к°Ђ м™„лЈЊлђ�м—€мќ„ л•Њ н�ём¶њлђ�лЉ” мЅњл°±л©”м†ЊмЉ¤лҐј мњ„н•њ мќён„°нЋ�мќґмЉ¤
     * Interface definition for a callback to be invoked
     * when {@link GetInboxListTask} has been finished.
     */
    ...
    private class GetInboxListTask extends AsyncTask<String, Object, Boolean>
    {
        ...
        protected Boolean doInBackground( String... params )
        {
            try
            {
                // IAP кµ¬л§¤н•њ мѓЃн’€ лЄ©лЎќ Interface лҐј н�ём¶њн•�м—¬ кІ°кіјлҐј к°Ђм ём�Ёл‹¤.
                ...
                // status Code, error String мќ„ м ЂмћҐн•ґл‘”л‹¤
        ...
        protected void onPostExecute( Boolean _result )
        {
            ...
            if( true == _result )
            {
                // 1) кµ¬л§¤ лЄ©лЎќмќ„ м„±кіµм ЃмњјлЎњ лЎњл”©н–€мќ„ кІЅмљ°
                ...
                // ============================================================
                // 2) кµ¬л§¤ лЄ©лЎќмќ„ к°Ђм ём�¤лЉ” лЏ™м•€ м—ђлџ¬к°Ђ л°њмѓќн•њ кІЅмљ°
    ...
    /**
     * IAP кІ°м њ кІ°кіјлЎњ л„�м–ґм�Ё PurchaseVOмќ� verifyUrlкіј purchaseId к°’мњјлЎњ
     * н•ґл‹№ кІ°м њмќ� мњ нљЁм„±мќ„ кІЂм‚¬н•њл‹¤. кІЂм‚¬кІ°кіј мњ нљЁн•њ кІЅмљ° мµњмў… кІ°м њ м„±кіµмњјлЎњ
     * нЊђл‹Ён•њл‹¤.<BR>
     * verify purchased result
     * <BR><BR>
     * 
     * вЂ» мўЂлЌ” м•€м „н•њ к±°лћ�лҐј мњ„н•ґм„њлЉ” ThirdParty м„њлІ„м—ђм„њ мњ нљЁм„± кІЂм‚¬н•  кІѓмќ„ к¶Њкі н•Ё.<BR>
     * вЂ» For a more secure transaction we recommend to verify from your server to IAP server.
     */
