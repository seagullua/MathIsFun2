...
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../libraries/ADLib/platform/Android/cpp/*.cpp)
FILE_LIST += $(wildcard $(LOCAL_PATH)/../../libraries/ADLib/platform/Android/cpp/Device/*.cpp)

LOCAL_SRC_FILES += $(FILE_LIST:$(LOCAL_PATH)/%=%)

LOCAL_CPPFLAGS += -DADADS_PROVIDER_ADMOB
