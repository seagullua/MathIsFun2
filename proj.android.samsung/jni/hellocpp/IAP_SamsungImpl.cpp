...
static const std::string SAMSUNG_CLASS = "com/sec/android/iap/SamsungStore";

void IAP_storeOpening()
{
	callStaticVoidMethod(SAMSUNG_CLASS, "storeOpening");
}

void IAP_storeClosing()
{
	callStaticVoidMethod(SAMSUNG_CLASS, "storeClosing");
}

void IAP_initialize(const std::string&)
{
	callStaticVoidMethod(SAMSUNG_CLASS, "initialize");
}

void IAP_buyMarketItem(const std::string& item)
{
	callStaticVoidMethod(SAMSUNG_CLASS, "buyMarketItem", item);
}

void IAP_restoreTransactions()
{
	callStaticVoidMethod(SAMSUNG_CLASS, "restoreTransactions");
}

	
extern "C" 
{
void Java_com_sec_android_iap_SamsungStore_EventbillingSupported(JNIEnv*  env, jobject thiz, jboolean param)
{
	if(param)
...
void Java_com_sec_android_iap_SamsungStore_EventrestoreTransactions(JNIEnv*  env, jobject thiz, jboolean param)
{
	LOGD("Native Event_restoreTransactions");
	IAP_Event_restoreTransactions(param);
}

void Java_com_sec_android_iap_SamsungStore_EventmarketPurchase(JNIEnv*  env, jobject thiz, jstring param)
{
	LOGD("Native Event_marketPurchase");
	IAP_Event_marketPurchase(JniHelper::jstring2string(param));
}

void Java_com_sec_android_iap_SamsungStore_EventmarketPurchaseCancelled(JNIEnv*  env, jobject thiz, jstring param)
{
