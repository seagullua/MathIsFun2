...
namespace ads
{
typedef ADAds::Banner Banner;
typedef ADAds AdsManager;
}
//namespace ads
//{
//class BannerSize;
...
//{
//public:
//    BannerSize(const unsigned int width, const unsigned int height);
//    const unsigned int getWidth() const;
//    const unsigned int getHeight() const;


//    static const BannerSize BANNER_BIG;
//    static const BannerSize BANNER_SMALL;
//private:
//    unsigned int _width;
...
//    const std::string getImageName(const BannerSize&) const;
//    bool hasImage(const BannerSize&) const;
