...
call "%PHP_DIR%" ResourceCompiler.php "texture_packer=%TEXTURE_PACKER_DIR%;platform=%PLATFORM%;project=%BUILD_PROJECT%;source=../Resources_storage;destination=../win8_phone/win8_phone/Assets;language=en,ru"
