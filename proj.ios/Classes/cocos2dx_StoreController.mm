...
#import "StoreBridge/cocos2dx_EventDispatcher.h"
...
void cocos2dx_StoreController::initialize(string customSecret) {
    ...
    [[StoreController getInstance] initializeWithStoreAssets:[[StoreAssets alloc] init] andCustomSecret:str];
    
    [cocos2dx_EventDispatcher initialize];
}

void cocos2dx_StoreController::buyMarketItem(string productId) {
    @try {
