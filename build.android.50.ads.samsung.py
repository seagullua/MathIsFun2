...
from build_android_config_50 import *
project.addModule('android_ADInfo_Store_SamsungStore')
project.addModule('android_ADInApp_SamsungStore')
project.output_name = 'proj.android.50.ads.samsung'
project.package_name = 'com.x4enjoy.mathisfun2.app'
project.addCppDir('VersionSelector/MiF50FreeDisableAds')
